...
**[Bookstore]** The Bookstore is a web application that allows users to manage their personal book collections. It provides features to add and delete books.
...
*git clone git@github.com:Akorede3133/bookstore.git
...
Feel free to check the [issues page](https://github.com/Akorede3133/bookstore/issues).
